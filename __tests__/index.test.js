...
test('should generate json diff for 2 json files', () => {
  ...
  expect(result).toEqual('[{"property":"common.follow","type":"added","value":false},{"property":"common.setting2","type":"removed","value":200},{"property":"common.setting3","type":"changed","value1":true,"value2":null},{"property":"common.setting4","type":"added","value":"blah blah"},{"property":"common.setting5","type":"added","value":{"key5":"value5"}},{"property":"common.setting6.doge.wow","type":"changed","value1":"","value2":"so much"},{"property":"common.setting6.ops","type":"added","value":"vops"},{"property":"group1.baz","type":"changed","value1":"bas","value2":"bars"},{"property":"group1.nest","type":"changed","value1":{"key":"value"},"value2":"str"},{"property":"group2","type":"removed","value":{"abc":12345,"deep":{"id":45}}},{"property":"group3","type":"added","value":{"deep":{"id":{"number":45}},"fee":100500}}]');
});
...
test('should throw error due to unsupported file extension', () => {
  expect(() => genDiff('__tests__/__fixtures__/123.txt', '__tests__/__fixtures__/2.json', 'blablaformat'))
    .toThrow(new Error('Unsupported extension \'txt\'.'));
});
